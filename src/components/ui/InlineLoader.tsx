    ...
    return (<Card style={{ marginTop: 16 }}>
      <div data-ui="inline-loader.1" className="inline-loader-shell">
        ...
        <div data-ui="inline-loader.3" className="inline-loader-content">
          <div data-ui="inline-loader.4" style={{ fontSize: 17, fontWeight: 800, color: C.g800, marginBottom: 8 }}>{title}</div>
          <div data-ui="inline-loader.5" style={{ fontSize: 15, color: C.g400, marginBottom: 12, lineHeight: 1.55 }}>{body}</div>
